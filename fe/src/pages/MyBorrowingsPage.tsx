...
export const MyBorrowingsPage = () => {
    ...
    const { data, isLoading, isError } = useBorrowings(pageNumber, pageSize);
    ...
    return (
        <div className="p-8">
            <h1 className="text-center text-3xl font-bold">My Borrowing Requests</h1>
            ...
            <div className="mt-8 w-full max-w-7xl mx-auto">
                ...
                <div className="grid">
                    <RequestTable requests={data?.results} isLoading={isLoading} isError={isError} />
                </div>
            </div>
        </div>
    )
