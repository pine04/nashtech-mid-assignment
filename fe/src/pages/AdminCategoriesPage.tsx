...
export const AdminCategoriesPage = () => {
    ...
    const { data, isLoading, isError } = useCategories(pageNumber, pageSize);
    ...
    return (
        <div className="p-8">
            <h1 className="text-center text-3xl font-bold">Category Management Page</h1>
            ...
            <div className="mt-8 w-full max-w-7xl mx-auto">
                ...
                <div className="grid">
                    <AdminCategoriesTable categories={data?.results} isLoading={isLoading} isError={isError} />
                </div>
            </div>
        </div>
    )
